...
> 🔗 **線上使用**: [https://Chenhao7797.github.io/dot-image-analyzer/](https://Chenhao7797.github.io/dot-image-analyzer/)
...
npm run dev
```
打開瀏覽器訪問顯示的網址 (通常是 [http://localhost:5173](http://localhost:5173))。
